...
#define MV_CONTROLLER_POSX(i)   	"controller" #i ".pos.x"                    /* The x position of controller with ID i, in meters. */
#define MV_CONTROLLER_POSY(i)   	"controller" #i ".pos.y"                    /* The x position of controller with ID i, in meters. */
...
MadaraController::MadaraController(int id, double commRange)
{
    ...
    m_host = "";
    m_settings.hosts_.resize (1);
    m_settings.hosts_[0] = DEFAULT_MULTICAST_ADDRESS;
    m_settings.type = Madara::Transport::MULTICAST;
    m_settings.id = id;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
void MadaraController::setupBridgeRequest(int sourceId)
{
...
void MadaraController::updateNetworkStatus(double controllerPosx, double controllerPosy, std::vector<DroneStatus> droneStatusList)
{
    ...
    updateMyStatus(controllerPosy, controllerPosy);
    ...
    m_knowledge->set(MV_TOTAL_DRONES, (Madara::Knowledge_Record::Integer) 5);
}
