  ...
  const Madara::Knowledge_Records & updates)
{
  ...
  strncpy_s (header.madara_id, MADARA_IDENTIFIER, 7);

  // copy the domain from settings
  strncpy_s (header.domain, this->settings_.domains.c_str (),
  ...
  strncpy_s (header.originator, id_.c_str (), sizeof (header.originator) - 1);
