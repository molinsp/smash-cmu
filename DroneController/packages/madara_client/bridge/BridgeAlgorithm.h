...
namespace SMASH
{
    namespace Bridge
    {
        ...
        public:
             ...
             * @param   commRange                 The range of the radio (in meters), used to calculate how many drones are required to form a bridge where each drone is within range of the next.
